// Copied from https://github.com/productbrew/react-native-reanimated-flip to avoid [Reanimated] Multiple versions of Reanimated were detected in `build.gradle` error
